...
CREATE TABLE aggregate_live_power_hourly (
    ...
    consumption_day_watt INTEGER NOT NULL DEFAULT 0,
    consumption_night_watt INTEGER NOT NULL DEFAULT 0,
    production_day_watt INTEGER NOT NULL DEFAULT 0,
    production_night_watt INTEGER NOT NULL DEFAULT 0,
